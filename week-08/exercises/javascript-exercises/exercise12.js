...
const areInOrder = function(num1, num2, num3) {
...
const areContiguous = function(num1, num2, num3) {
    return (num1 === num2 - 1 && num2 === num3 - 1) || // three ascending numbers
           (num1 === num2 + 1 && num2 === num3 + 1) || // three descending numbers
           (num1 === num3 && Math.abs(num1 - num2) === 1) // two equal numbers and one adjacent number
  };
...
const isAscendingContiguous = function(num1, num2, num3) {
